...
function onProjectBacklogLoad()
{
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        if (array[i].taskTag == filterBy){
            ...
            htmlElements += `<div id="box" class = 'mdl-cell mdl-cell--3-col graybox pbiBox' onclick = createDetailedView(${i}) style =  'position: relative; top: 90%' id="${i}"><p id = 'taskText'>${taskName}<br>Priority: ${priority}<br>Story Points:${storyPoints} Task Tag: ${taskTag}</p></div>` +
